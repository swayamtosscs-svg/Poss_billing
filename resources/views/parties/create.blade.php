<x-app-layout>
    ...
    <div class="py-8 max-w-5xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg p-6 space-y-6">
            <div>
                <h3 class="text-lg font-semibold text-gray-900">{{ __('Party Details') }}</h3>
                <p class="text-sm text-gray-500">{{ __('Capture supplier or party details for purchase tracking and payments.') }}</p>
            </div>
